...
class BaseMPS:
    ...
    def __init__(
        ...
        @partial(jit, backend=self.backend, static_argnums=(1, 2, 3))
        def svd_multi_strat(
            tensor, pivot_axis=2, max_singular_values=None, max_truncation_error=None, truncation_mode=None
        ):
            return self.backend.svd_multi_strat(
                tensor=tensor,
                pivot_axis=pivot_axis,
                max_singular_values=max_singular_values,
                max_truncation_error=max_truncation_error,
        ...
        self.svd_multi_strat = svd_multi_strat
